...
function handleSystem (e)
  ...
  return (
    ...
    <div className="form-floating mb-4">
      ...
      <label htmlFor='inputAddress' >Seven</label>
    </div>
    <div className="form-floating mb-4 ">
      <input 
        type="text" 
      ...
      <label htmlFor='inputName' >Eight</label>
    </div>
    <div className="form-floating mb-4 ">
      <input 
        type="text" 
      ...
      <label htmlFor='inputName'>Nine</label>
    </div>
    <div className="form-floating mb-4 ">
      <input 
        type="text" 
      ...
      <label htmlFor='inputName'>Ten</label>
    </div>
